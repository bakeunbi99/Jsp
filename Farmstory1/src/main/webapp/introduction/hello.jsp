...
<div id="sub" class="cate1">
    ...
    <section>
        ...
        <article>
            ...
            <!-- 내용 시작 -->
          	<img src="/Farmstory1/img/sub_page1_article_bg.jpg" alt="인사말 배경이미지">
			<img src="/Farmstory1/img/sub_page1_article_txt.png" alt="인사말 이미지1">
			
			<div>
				<p>
				함상 저희 팜스토리를 성원해 주시고 관심을 가져주시는 모든 분들께 감사의 인사를 드리며<br/>
				가정에 건강과 행복이 가득하시길 기원합니다.
				</p>
				<p>
				팜스토리는 신선하고 안전한 먹거리로 건강한 삶 만들기에 기여합니다.<br/>
				보다 좋은 농산품을 공급하기 위해 화학비료를 쓰지 않는 건강한 흙에서 유기농업으로 정성을<br/>
				다해 지은 농사를 통해 믿고 먹을 수 있는 먹거리 제공에 앞장서겠습니다.
				</p>
				<p>
			...
			<img src="/Farmstory1/img/sub_page1_article_family.png" alt="인사말 이미지1">
